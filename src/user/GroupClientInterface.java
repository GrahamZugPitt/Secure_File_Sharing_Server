...
//    /**
//     * Connect to the specified group server. No other methods should work until
//     * the client is connected to a group server.
//     *
...
//    public boolean connect(final String server, final int port);
     ...
     * @param serverKey The public key for the server this token will be used with
     *
     * @return A UserToken describing the permissions of "username." If this
     * user does not exist, a null value will be returned.
     *
     */
    public UserToken getToken(final String username, final String password, PublicKey serverKey);

    /**
     * Creates a new user.This method should only succeed if the user invoking
     * it is a member of the special group "ADMIN".
     *
    ...
    /**
     * Deletes a user. This method should only succeed if the user invoking it
     * is a member of the special group "ADMIN". Deleting a user should also
     * remove him or her from all existing groups.
     *
    ...
    /**
     * Creates a new group. Any user may create a group, provided that it does
     * not already exist.
     *
    ...
    /**
     * Deletes a group. This method should only succeed if the user invoking it
     * is the user that originally created the group.
     *
    ...
    /**
     * Adds a user to some group. This method should succeed if the user
     ...
     *
     * @return A List of group members. Note that an empty list means a group
     * has no members, while a null return indicates an error.
     */
