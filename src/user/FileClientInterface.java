...
//    public boolean connect(final String server, final int port);
     ...
     *
     */
    public boolean download(final String group, final String sourceFile, final String destFile, final UserToken token);
     ...
     *
     */
    public boolean delete(final String groupname, final String filename, final UserToken token);
